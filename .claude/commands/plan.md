...
Uma vez que o plan.md esteja finalizado, e o humano concorde com o seu entendimento, informe ao humano que ELE deve prosseguir para o próximo passo através do comando /work em uma nova sessão do Claude Code (use /clear ou abra uma nova sessão para limpar o contexto). Relembre-o que ele precisará executar o /warm-up na nova sessão antes de ir para o /work.
